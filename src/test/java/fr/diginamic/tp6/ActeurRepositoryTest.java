...
public class ActeurRepositoryTest {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pu_essai");
    ...
    public void testExtraireActeursParIdentite() {
        TypedQuery<Acteur> query = em.createQuery("SELECT a FROM Acteur a WHERE a.identite LIKE 'Marion Cotillard'", Acteur.class);
        List<Acteur> acteurs = query.getResultList();
